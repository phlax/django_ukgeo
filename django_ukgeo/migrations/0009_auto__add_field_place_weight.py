...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.weight'
        db.add_column('django_ukgeo_place', 'weight', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.weight'
        db.delete_column('django_ukgeo_place', 'weight')
