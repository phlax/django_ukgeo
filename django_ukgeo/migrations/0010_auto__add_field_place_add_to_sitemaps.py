...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.add_to_sitemaps'
        db.add_column('django_ukgeo_place', 'add_to_sitemaps', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.add_to_sitemaps'
        db.delete_column('django_ukgeo_place', 'add_to_sitemaps')


    models = {
        'django_ukgeo.place': {
            'Meta': {'object_name': 'Place'},
            'add_to_sitemaps': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
